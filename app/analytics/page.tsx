...
export default function AnalyticsPage() {
    ...
    return (
        <main className="w-full bg-[#F9FAFB] min-h-screen overflow-x-hidden transition-all duration-300">
            ...
            <div className="p-5 pb-24 md:p-8 md:pb-8 space-y-8">
                {/* Control Bar */}
                <div className="flex flex-col sm:flex-row justify-between items-center gap-3 bg-white p-4 rounded-2xl border border-[#F3F4F3] shadow-sm">
                    <div className="flex items-center gap-2 w-full sm:w-auto">
                        <div className="flex items-center gap-1 bg-slate-50 p-1 rounded-xl flex-1 sm:flex-none">
                            {filterMode === 'monthly' && (
                                <button
                                    onClick={prevMonth}
                            ...
                            <div className="flex items-center gap-2 px-3 py-1.5 flex-1 justify-center">
                                <Calendar className="w-4 h-4 text-[#165DFF] shrink-0" />
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto">
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-bold transition-all w-full sm:w-auto justify-center ${showSettings ? 'bg-[#165DFF] text-white shadow-lg shadow-blue-500/30' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'}`}
                        >
